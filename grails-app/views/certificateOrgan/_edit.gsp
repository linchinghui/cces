			...
			<div class="panel panel-info"><g:if test="${modalPage}">
				...
				<div class="panel-body"> <%--
					...
					<section class="content">
						<g:form resource="${certificateOrgan}" method="${submitMehtod}" role="form" class="form-horizontal" name="certificateOrganForm">
							<g:if test="${certificateOrgan}">
								...
								<fieldset class="form-group">
									<f:with bean="certificateOrgan">
										<g:if test="${type=='C'}">
											<f:field property="code" label="機構代碼" widget-placeholder="英文字母(不含符號)" />
										</g:if>
										<g:else>
											<f:display property="code" label="機構代碼" />
										</g:else>
										<f:field property="description" label="機構名稱" />
									</f:with>
								</fieldset>
...
$(function() {
	var editForm = $('#certificateOrganForm');
