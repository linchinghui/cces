...
<%@ page import="org.springframework.security.web.authentication.session.*"%>
...
<body>
  <div class="container" role="main">
    ...
    <div id="box-login" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
          ...
          <form name="form-signin" class="form-horizontal" role="form" action='/login' method='POST'>
            ...
            <div class="form-group"><%-- Button --%>
              <div class="col-sm-12 controls">
                ...
                <g:if test="${session['SPRING_SECURITY_LAST_EXCEPTION'] instanceof SessionAuthenticationException}">
