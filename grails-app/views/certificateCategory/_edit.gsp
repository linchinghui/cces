			...
			<div class="panel panel-info"><g:if test="${modalPage}">
				...
				<div class="panel-body"> <%--
					...
					<section class="content">
						<g:form resource="${certificateCategory}" method="${submitMehtod}" role="form" class="form-horizontal" name="certificateCategoryForm">
							<g:if test="${certificateCategory}">
								...
								<fieldset class="form-group">
									<f:with bean="certificateCategory">
										...
										<f:field property="permanent" label="永久有效" />
									</f:with>
								</fieldset>
...
$(function() {
	var editForm = $('#certificateCategoryForm');
