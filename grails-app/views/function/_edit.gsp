...
<g:set var="pageTitle" value="${functionService.get('function')?.description}-${type=='C' ? '新增' : type=='U' ? '編輯' : ''}"/>
                        ...
                        <g:if test="${function}">
                            ...
                            <fieldset class="form-group">
                                <f:with bean="function">
                                    ...
                                    <f:field property="description" label="作業項目" widget-placeholder="輸入中英文說明" />
                                </f:with>
                            </fieldset>
